...
echo on
::python -m robot.run -A local_args.txt --test "Test Smoke test Quote - Broker" --loglevel TRACE --outputdir "Reports\SG" robot-tests\sg\sgquote
...
python -m robot.run -A local_args.txt --include smokeANDsgANDenrollment --exclude draft --loglevel TRACE --outputdir "Reports\stg\qt" robot-tests
